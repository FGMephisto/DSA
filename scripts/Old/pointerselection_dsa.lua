...
function updateColors()
	...
	if identity then
		GlobalRegistry.colortables = GlobalRegistry.colortables or {};
		GlobalRegistry.colortables[User.getCampaignName()] = GlobalRegistry.colortables[User.getCampaignName()] or {}; 
		GlobalRegistry.colortables[User.getCampaignName()][identity] = GlobalRegistry.colortables[User.getCampaignName()][identity] or {};

		GlobalRegistry.colortables[User.getCampaignName()][identity].color = colorstr;
		GlobalRegistry.colortables[User.getCampaignName()][identity].blacktext = blacktext;
	end
end
