...
aListViews = {
	...
	["item"] = {
		["armor"] = {
			...
			aGroupValueOrder = { "Light", "Medium", "Heavy", },
		},
		["weapon"] = {
			aColumns = {
				{ sName = "name", sType = "string", sHeadingRes = "item_grouped_label_name", nWidth=200 },
				...
				{ sName = "critical", sType = "number", sHeadingRes = "item_grouped_label_critical", nWidth=40, bCentered=true },
				{ sName = "range", sType = "number", sHeadingRes = "item_grouped_label_range", sTooltipRes = "item_grouped_tooltip_range", nWidth=40, bCentered=true },
				{ sName = "weight", sType = "number", sHeadingRes = "item_grouped_label_weight", sTooltipRes = "item_grouped_tooltip_weight", nWidth=40, bCentered=true },
				{ sName = "stundc", sType = "number", sHeadingRes = "item_grouped_label_stundc", nWidth=60, bCentered=true },
				{ sName = "damagetype", sType = "string", sHeadingRes = "item_grouped_label_damagetype", nWidth=60 },
				{ sName = "firingmodes", sType = "string", sHeadingRes = "item_grouped_label_firingmodes", sTooltipRes = "item_grouped_tooltip_firingmodes", nWidth=40, bCentered=true },
				{ sName = "size", sType = "string", sHeadingRes = "item_grouped_label_size", nWidth=60 }
			},
			aFilters = {
